/*
 * Minimal PCI register definitions for virtio-pci on AArch64
 * Copied from i386 variant; used by userland PCI access via PCI server.
 */
...
#define PCI_T3_VGA_OLD		0x000100
#define	PCI_T3_RAID		0x010400
#define PCI_T3_AHCI		0x010601
#define PCI_T3_VGA		0x030000
...
#define CAP_T_SECURE_DEV	0x0f
#define CAP_SD_INFO		2
#define 	CAP_SD_SUBTYPE_MASK	0x0f
#define			CAP_T_SD_DEV		0
